...
const View = (() => {
    ...
    const todoListCompleteEl = document.querySelector(".complete")

    const renderTodos = (todos) => {
        let todosTemplate = "";
        let todosCompleteTemplate = "";
        const todosincomplete = todos.filter(todo => {
            return !todo.complete;
        })
        const todoscomplete = todos.filter(todo => {
            return todo.complete;
        })
...
<button class="move-btn" id="${todo.id}">move</button></li>`;
        ...
        todoscomplete.forEach((todo) => {

                const liTemplate = `<li><button class="move-btn" id="${todo.id}">move</button><span>${todo.content}</span>
<button class="edit-btn" id="${todo.id}">edit</button>
<button class="delete-btn" id="${todo.id}">delete</button></li>`;
        ...
        todoListCompleteEl.innerHTML = todosCompleteTemplate;
    };
    ...
    return { renderTodos, submitBtnEl, inputEl, clearInput, todolistEl, todoListCompleteEl };
})();
